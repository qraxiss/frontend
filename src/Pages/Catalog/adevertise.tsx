        ...
        <React.Fragment>
            <div className="offer-bar flex-shrink-0">
                <div className="d-flex gap-3 flex-column">
                        ...
                        <Card.Body>
                            ...
                            <div className="mt-4 text-center">
                                ...
                                <Link to="#" className="stretched-link">
                                    <h5 className="mb-4">Ninja Pro Max Smartwatch</h5>
                                </Link>
                            </div>
                    ...
                    <div
                        className="offer-banner rounded-3"
                        style={{ backgroundImage: `url(${offerbanner})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                    ></div>
                </div>
            </div>
        </React.Fragment>
