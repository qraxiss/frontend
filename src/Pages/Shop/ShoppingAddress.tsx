                ...
                <Row className="gy-3">
                    ...
                    <Col lg={6} xs={12}>
                        ...
                        <div className="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                            ...
                            <div>
                                <Link to="#removeAddressModal" className="d-block text-body p-1 px-2" data-bs-toggle="modal">
                                    <i className="ri-delete-bin-fill text-muted align-bottom me-1" onClick={RemoveModel}></i> Remove
                                </Link>
                            </div>
                        </div>
                    </Col>
