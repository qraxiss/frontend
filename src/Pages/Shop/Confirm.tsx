                                ...
                                <Card.Body className="p-4 p-md-5">
                                    ...
                                    <div className="text-center mt-5 pt-1">
                                        ...
                                        <div className="mt-4 pt-2 hstack gap-2 justify-content-center">
                                            <Link to="/shop/orderhistory" className="btn btn-primary btn-hover">
                                                View Order <i className="ri-arrow-right-line align-bottom ms-1"></i>
                                            </Link>
                                            <Link to="/dashboard" className="btn btn-soft-danger btn-hover">
                                                Back To Home <i className="ri-home-4-line align-bottom ms-1"></i>
                                            </Link>
                                        </div>
                                    </div>
                                </Card.Body>
