...
export const StoreMap = () => {
    return (
        <React.Fragment>
            <div id="world-map-markers" data-colors='["--tb-light"]' style={{ height: '500px' }} dir="ltr" className="jvm-container">
                <svg width="736" height="500">
                    <defs></defs>
                    <g id="jvm-regions-group" transform="scale(0.8177777777777778) translate(0, 14.166395693160716)">
                        <path
                        ...
                        ></path>
                        <path
                            d="M448.79,409.52l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                            data-code="GQ"
                            fill="#f3f6f9"
                            fillOpacity="1"
                            stroke="#9599ad"
                        ...
                        ></path>
                        <path
                            d="M839.03,452.86l0.23,1.16l-0.44,0.03l-0.2,-1.47l0.42,0.28Z"
                            data-code="VU"
                            fill="#f3f6f9"
                            fillOpacity="1"
                            stroke="#9599ad"
                        ...
                        ></path>
                        <path
                            d="M504.86,320.38l0.39,0.01l0.27,-0.07l-0.3,0.35l-0.36,-0.28Z"
                            data-code="XC"
                            fill="#f3f6f9"
                            fillOpacity="1"
                            stroke="#9599ad"
                        ...
                        ></path>
                        <path
                            d="M436.07,271.5l-0.48,-0.1l0.29,-1.66l0.29,0.51l-0.1,1.25Z"
                            data-code="LU"
                            fill="#f3f6f9"
                            fillOpacity="1"
                            stroke="#9599ad"
                    ...
                    <g id="jvm-markers-group">
                        <circle
                            data-index="0"
                            cx="415.61316585059006"
                            cy="283.85625647258087"
                            r="7"
                            fill="red"
                            fillOpacity="1"
                            stroke="#FFF"
                            strokeWidth="5"
                            strokeOpacity="0.5"
                            className="jvm-marker jvm-element"
                        ></circle>
                        <circle
                            data-index="1"
                            cx="559.911472841098"
                            cy="189.88637386596884"
                            r="7"
                            fill="#038edc"
                            fillOpacity="1"
                            stroke="#FFF"
                        ...
                        <circle
                            data-index="2"
                            cx="365.6481733377743"
                            cy="228.45159448259668"
                            r="7"
                            fill="red"
                            fillOpacity="1"
                            stroke="#FFF"
                        ...
                        <circle
                            data-index="3"
                            cx="237.9168794097408"
                            cy="380.24546277515253"
                            r="7"
                            fill="#038edc"
                            fillOpacity="1"
                            stroke="#FFF"
                    ...
                    <g id="jvm-markers-labels-group">
                        <text
                            data-index="0"
                            x="427.61316585059006"
                            y="283.85625647258087"
                            dy="0.6ex"
                            fontFamily="Verdana"
                            fontSize="12"
                            fontWeight="500"
