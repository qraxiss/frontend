                        ...
                        <Col lg={5} className="ms-auto">
                            <div className="ecommerce-product-widgets mt-4 mt-lg-0">
                                <div className="mb-4">
                                    ...
                                    <h4 className="lh-base mb-1">Opinion Striped Round Neck Green T-shirt</h4>
                                    <p className="text-muted mb-4">
                                        The best part about stripped t shirt denim &amp; white sneakers or wear it with a cool chinos and blazer to
                                        dress up{' '}
                                        ...
                                        <li>
                                            <div className="d-flex gap-3">
                                                ...
                                                <div className="flex-grow-1">
                                                    <b>Bank Offer</b> 10% instant discount on Federal Bank Debit Cards, up to ₹3000 on orders of
                                                    ₹5,000 and above
                                                        ...
                                                        <SimpleBar className="mt-4" style={{ maxHeight: '350px' }}>
                                                            <div className="d-flex p-3 border-bottom border-bottom-dashed">
                                                                <div className="flex-shrink-0 me-3">
                                                                    <Image className="avatar-xs" src={avatar5} alt="" roundedCircle />
                                                                </div>
                                                                <div className="flex-grow-1">
                                                                    ...
                                                                    <div>
                                                                        <h5 className="lh-base fs-15">Design Quality</h5>
                                                                        <p className="mb-0">
                                                                            " This is an incredible framework worth so much in the right hands!
                                                                            Nowhere else are you going to get so much flexibility and great code for a
                                                                            few dollars. Highly recommend purchasing today! Like right now! "
                                                                        </p>
                                                                    </div>
                                                                    <div className="d-flex mt-4">
                                                                        <div className="flex-shrink-0 me-3">
                                                                            <Image className="avatar-xs" src={avatar1} alt="" roundedCircle />
                                                                        </div>
                                                                        <div className="flex-grow-1">
                                                                            <div className="d-flex mb-3">
                                                                                <div className="flex-grow-1">
                                                                                    <div>
                                                                                        ...
                                                                                        <p className="mb-0 text-muted fs-13">Admin</p>
                                                                                    </div>
                                                                                </div>
                                                                                <div className="flex-shrink-0">
                                                                                    <p className="mb-0 text-muted">
                                                            ...
                                                            <div className="d-flex p-3 border-bottom border-bottom-dashed">
                                                                <div className="flex-shrink-0 me-3">
                                                                    <Image className="avatar-xs" src={avatar3} alt="" roundedCircle />
                                                                </div>
                                                                <div className="flex-grow-1">
                                                                    <div className="d-flex mb-3">
                                                                        <div className="flex-grow-1">
                                                                    ...
                                                                    <div>
                                                                        <h5 className="lh-base fs-15">Feature Availability</h5>
                                                                        <p className="mb-0">
                                                                            " Hello everyone, I would like to suggest here two contents that you could
                                                                            create. Course pages and blog pages. In them you could insert the listing
                                                                            and management of courses and listing and management of blog. The theme is
                                                            ...
                                                            <div className="d-flex p-3 border-bottom border-bottom-dashed mb-3">
                                                                <div className="flex-shrink-0 me-3">
                                                                    <Image className="avatar-xs" src={avatar8} alt="" roundedCircle />
                                                                </div>
                                                                <div className="flex-grow-1">
                                                                    <div className="d-flex mb-3">
                                                                        <div className="flex-grow-1">
                                                                    ...
                                                                    <div>
                                                                        <h5 className="lh-base fs-15">Design Quality</h5>
                                                                        <p className="mb-0">
                                                                            "We have used your other templates as well and seems it's amazing with the
                                                                            design and code quality. Wish you best for the future updates. Keep
                                                        ...
                                                        <div className="pt-3">
                                                            ...
                                                            <div>
                                                                <Form action="#">
                                                                    ...
                                                                    <div className="mb-3">
                                                                        <Form.Control name="your-name" placeholder="Title" type="text" />
                                                                    </div>
                                                                    <div className="mb-3">
                                                                        <Form.Control
                                                                            as="textarea"
                                                                    ...
                                                                    <div className="text-end">
                                                                        <Button variant="primary" className="btn-hover" type="submit" value="Submit">
                                                                            Send Review
                ...
                <Container>
                    ...
                    <Row className="gy-3">
                        {(productInterestedCard || [])?.map((item, idx) => {
                            return (
                                <Col lg={4} key={idx}>
                                    <Card as="a" href="/products-grid/right" className="card mb-3 card-animate stretched-link">
                                        <Row className="g-0">
                                            <Col sm={4}>
                                                <Image src={item.img} className="rounded-start h-100 object-fit-cover" alt="..." fluid />
                                            </Col>
                                            <Col sm={8}>
