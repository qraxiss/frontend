                                ...
                                <Col lg={12}>
                                    ...
                                    <div className="d-flex gap-2 mb-2">
                                        ...
                                        <p className="text-muted fs-15 flex-grow-1 mb-0">
                                            ...
                                            Website Name accessible at Website.com. By accessing this website we assume you accept these terms and
                                            conditions. Do not continue to use Website Name if you do not agree to take all of the terms and
                                    ...
                                    <div className="d-flex gap-2 mb-2">
                                        ...
                                        <p className="text-muted fs-15 flex-grow-1 mb-0">
                                            ...
                                            material on Website Name. All intellectual property rights are reserved. You may access this from Website
                                    ...
                                    <div className="hstack justify-content-sm-end gap-2 mt-4">
                                        <Link to="#" className="btn btn-ghost-danger btn-hover me-3">
