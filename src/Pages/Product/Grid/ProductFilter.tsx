        ...
        <Card className="overflow-hidden">
          <Card.Header>
            ...
            <div className="search-box">
              <Form.Control type="text" id="searchProductList" autoComplete="off" placeholder="Search Products..." />
                  ...
                  <div className="accordion-collapse collapse show" aria-labelledby="flush-headingSize">
                    <div className="accordion-body text-body pt-0">
                      <ul className="clothe-size list-unstyled hstack gap-3 mb-0 flex-wrap" id="size-filter">
                        <li>
                          <Form.Control type="radio" name="sizes" value="xs" id="sizeXs" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="s" id="sizeS" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="sizeS"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="m" id="sizeM" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="sizeM"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="l" id="sizeL" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="sizeL"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="xl" id="sizeXl" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="sizeXl"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="2xl" id="size2xl" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="size2xl"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="3xl" id="size3xl" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="size3xl"
                          >
                        ...
                        <li>
                          <Form.Control type="radio" name="sizes" value="4xl" id="size4xl" onClick={(e: any) => handleSize(e.target)} />
                          <Form.Label
                            className="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                            htmlFor="size4xl"
                          >
                    ...
                    <div className="accordion-body text-body pt-0">
                      ...
                      <div className="d-flex flex-column gap-2 mt-3 filter-check">
                        <div className="form-check">
                          <Form.Control className="form-check-input" type="checkbox" value="Boat" id="productBrandRadio5" />
                          <Form.Label className="form-check-label" htmlFor="productBrandRadio5">
                            Boat
                          </Form.Label>
                        </div>
                        <div className="form-check">
                          <Form.Control className="form-check-input" type="checkbox" value="OnePlus" id="productBrandRadio4" />
                          <Form.Label className="form-check-label" htmlFor="productBrandRadio4">
                            OnePlus
                          </Form.Label>
                        </div>
                        <div className="form-check">
                          <Form.Control className="form-check-input" type="checkbox" value="Realme" id="productBrandRadio3" />
                          <Form.Label className="form-check-label" htmlFor="productBrandRadio3">
                            Realme
                          </Form.Label>
                        </div>
                        <div className="form-check">
                          <Form.Control className="form-check-input" type="checkbox" value="Sony" id="productBrandRadio2" />
                          <Form.Label className="form-check-label" htmlFor="productBrandRadio2">
                            Sony
                          </Form.Label>
                        </div>
                        <div className="form-check">
                          <Form.Control className="form-check-input" type="checkbox" value="JBL" id="productBrandRadio1" />
                          <Form.Label className="form-check-label" htmlFor="productBrandRadio1">
                            JBL
                          </Form.Label>
                        </div>

                        <div>
                          <Button className="btn btn-link text-decoration-none text-uppercase fw-medium p-0">1,235 More</Button>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="d-flex flex-column gap-2 filter-check" id="discount-filter">
                        <div className="form-check">
                          <Form.Control
                            ...
                            onClick={(e: any) => handleDic(e.target)}
                          />
                          <Form.Label className="form-check-label" htmlFor="productdiscountRadio6">
                            50% or more
                          </Form.Label>
                        </div>
                        <div className="form-check">
                          <Form.Control
                            ...
                            onClick={(e: any) => handleDic(e.target)}
                          />
                          <Form.Label className="form-check-label" htmlFor="productdiscountRadio5">
                            40% or more
                          </Form.Label>
                        </div>
                        <div className="form-check">
