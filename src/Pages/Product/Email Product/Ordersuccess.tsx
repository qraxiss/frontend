            ...
            >
                ...
                >
                    <div style={{ padding: '1.5rem', backgroundColor: '#fafafa' }}>
                        <Link to="#">
                            <Image src={logodark} alt="" height="28" style={{ display: 'block', margin: '0 auto' }} />
                        </Link>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td style={{ padding: '5px', verticalAlign: 'top' }}>
                                        ...
                                        <h6 style={{ fontSize: '15px', margin: '0px', fontWeight: 600, fontFamily: "'Inter', sans-serif" }}>
                                            01 Jan, 2023
                                        </h6>
                                    </td>
                                    <td style={{ padding: '5px', verticalAlign: 'top' }}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ padding: '12px 5px', verticalAlign: 'top' }}>
                                        <h6 style={{ fontSize: '15px', margin: '0px', fontWeight: 500, fontFamily: "'Inter', sans-serif" }}>
                    ...
                    <div style={{ padding: '1.5rem', backgroundColor: '#fafafa' }}>
                        <div style={{ display: 'flex', gap: '5px', justifyContent: 'space-between' }}>
                            ...
                            <p style={{ color: '#878a99', margin: '0' }}>
                                <script>document.write(new Date().getFullYear())</script>2023 © Toner.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                >
                    ...
                    <div style={{ padding: '1.5rem' }}>
                        ...
                        <h6 style={{ fontSize: '16px', fontWeight: 500, marginBottom: '12px', marginTop: '0px', lineHeight: 1.2, color: '#fafafa' }}>
                            Hello, Edward
                        </h6>
                        <p style={{ color: '#878a99 ', marginBottom: '20px', marginTop: '0px' }}>
                            Your order has been Confirmed and will be shipping soon.
                        ...
                        <div style={{ textAlign: 'right' }}>
                            <h6 style={{ fontSize: '17px', margin: '0px', fontWeight: 500, fontFamily: "'Inter', sans-serif", color: '#fafafa' }}>
                                Thank you!
                            </h6>
                            <p style={{ color: '#878a99 ', marginBottom: '0', marginTop: '8px' }}>Themesbrand</p>
                        </div>
