      ...
      >
        <div
          style={{
            ...
            borderRadius: '6px',
            overflow: 'hidden',
            backgroundColor: 'rgb(206, 236, 250)',
            position: 'relative'
          }}
        >
          ...
          <div style={{ padding: '3.5rem', zIndex: 1, position: 'relative' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              >
                <span style={{ fontSize: '120px' }}>50</span> <span style={{ width: '20px', display: 'inline-block' }}>% Off</span>
              </h5>
              <p style={{ color: '#0d355d', marginBottom: '25px', marginTop: '0px', lineHeight: '1.5' }}>
                Black Friday always occurs the day after Thanksgiving, but the exact date changes from year to year. In 2022, Black Friday falls on
                November 25.
              </p>
            </div>
            <div>
              ...
              <p style={{ color: '#0d355d ', marginBottom: '25px', marginTop: '0px', lineHeight: '1.5', textAlign: 'center' }}>
              ...
              <div style={{ textAlign: 'center', marginTop: '25px' }}>
                ...
                <p style={{ margin: '8px 0 0 0', fontSize: '13px' }}>
                  Use code <b>BLACK</b> at checkout
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div style={{ padding: '3.5rem', zIndex: 1, position: 'relative' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#9eb8d1', marginBottom: '25px', marginTop: '0px', lineHeight: '1.5' }}>
                Black Friday always occurs the day after Thanksgiving, but the exact date changes from year to year. In 2022, Black Friday falls on
                November 25.
              </p>
            </div>
            <div>
              ...
              <p style={{ color: '#9eb8d1 ', marginBottom: '25px', marginTop: '0px', lineHeight: '1.5', textAlign: 'center' }}>
                On Clothes for kids,women &amp; Mens Wear
              </p>
              <Table style={{ width: '100%' }} cellSpacing="0" cellPadding="0">
                <tbody>
