                    ...
                    <Card.Body>
                      <div className="entry-meta">
                        <Link to="#" className="text-muted">
                          {item.like} <i className="mdi mdi-like"></i> Like
                        </Link>
                      ...
                      <div className="mt-3">
                        <Link to="#">
                          <h5 className="fs-17 lh-base">{item.title}</h5>
                        </Link>
                        <p className="text-muted fs-15 mt-2">{item.discription}</p>
                        <Link to="#" className="link-effect link-info">
                          Continue Reading <i className="bi bi-arrow-right ms-2"></i>
                        </Link>
                      </div>
                    </Card.Body>
                  </Card>
