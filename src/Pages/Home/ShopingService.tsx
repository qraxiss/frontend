      ...
      <section className="position-relative bg-danger-subtle bg-cta">
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="py-5">
                <p className="text-uppercase  badge bg-danger-subtle text-danger fs-13">
                ...
                <p className="fs-16 mt-2">
                  The hands-down winner of denim-friendly sandal styles has to be flat and simple thong sandals. They can be paired with virtually
                  every style of women's jeans imaginable, and, as long as you can stand the toe strap, they tend to be really comfortable as well.
                </p>
                <Row>
                  <Col lg={10}>
