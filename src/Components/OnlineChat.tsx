          ...
          <div className="chat-box">
            <Card className="shadow-lg border-0 rounded-bottom-0 mb-0">
              <Card.Header className="bg-success d-flex align-items-center border-0">
                ...
                <Button className="btn-close btn-close-white flex-shrink-0" onClick={chatBot} data-bs-dismiss="collapse" aria-label="Close" />
              </Card.Header>
              <Card.Body className="p-0">
                <SimpleBar style={{ height: 280 }}>
                  <div id="users-chat-widget">
                    <div className="chat-conversation p-3" id="chat-conversation" data-simplebar="">
                              ...
                              <div className="ctext-wrap">
                                <div className="ctext-wrap-content">
                                  <p className="mb-0 ctext-content">
                                    Welcome to Themesbrand. We are here to help you. You can also directly email us at Support@themesbrand.com to
                  ...
                  <Row className="g-2 mt-2 mx-3 mb-3">
                    <Col>
                      <div className="position-relative">
                        <Form.Control className="border-light bg-light" placeholder="Enter Message..." />
                      </div>
                    </Col>
