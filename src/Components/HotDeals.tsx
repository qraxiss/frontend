            ...
            <Col lg={12}>
              <div className="d-flex align-items-center justify-content-between mb-4 pb-1">
                ...
                <div className="flex-shrink-0">
                  <Link to="#" className="link-effect link-success fw-medium">
                    View All Products <i className="ri-arrow-right-line ms-1 align-bottom"></i>
                  </Link>
                </div>
              </div>
            </Col>
                    ...
                    <div className="content mx-4 pt-5">
                      <div className="card border-0 p-4 position-relative rounded-3 shadow-lg">
                        ...
                        <p className="text-muted">
                          ...
                          <i className="ri-star-fill text-warning align-bottom"></i>
                          <i className="ri-star-fill text-warning align-bottom"></i>
                          <i className="ri-star-half-fill text-warning align-bottom"></i> ({item.rat})
                        </p>
                        <div className="mt-3 d-flex align-items-center">
                          ...
                          <Link to="#" className="btn btn-primary btn-sm">
                            <i className="ri-shopping-bag-line align-bottom me-1"></i> Add
                          </Link>
                        </div>
                      </div>
                    </div>
