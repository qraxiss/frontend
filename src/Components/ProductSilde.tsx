                    ...
                    (fileter || [])?.map((item: any, inx: any) => {
                        return (
                            <Col
                                ...
                                lg={4}
                                md={6}
                                className={`element-item seller ${item.category}`}
                                        ...
                                        <div className="gallery-product-actions">
                                            <div className="mb-2">
                                                <Button
                                                    type="button"
                                                    variant="danger"
                                                    className="btn-sm custom-toggle"
                                                    data-bs-toggle="button"
                                                    onClick={(e) => Tooglelike(e.target)}
                                                >
                                                    <span className="icon-on">
                                                        <i className="mdi mdi-heart-outline align-bottom fs-15"></i>
                                                    </span>
                                                    <span className="icon-off">
                                                        <i className="mdi mdi-heart align-bottom fs-15"></i>
                                                    </span>
                                                </Button>
                                            </div>
                                            ...
                                            <div>
                                                <Button
                                                    ...
                                                    className=" btn-sm custom-toggle"
                                                    data-bs-toggle="button"
                                                    onClick={(e) => Toogleview(e.target)}
                                                >
                                                    <span className="icon-on">
                                                        <i className="mdi mdi-eye-outline align-bottom fs-15"></i>
                                                    </span>
                                                    <span className="icon-off">
                                                        <i className="mdi mdi-eye align-bottom fs-15"></i>
                                                    </span>
                                                </Button>
                                            </div>
                                        </div>
                                        <div className="product-btn px-3">
                                            <Link to="/shop/shopingcard" className="btn btn-primary btn-sm w-75 add-btn">
                                    ...
                                    <div>
                                        ...
                                        <div className="pb-3">
                                            <div
                                                ...
                                                className="mb-4 noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr"
                                            >
                                                <Nouislider
            ...
            <Row className="g-3">
                    ...
                    <div className="product-banner-1 mt-3 mt-lg-0 rounded overflow-hidden">
                        ...
                        <div className="product-content p-4">
                            ...
                            <div className="product-btn mt-3 mt-xl-4">
                                <Link to="#" className="link-effect link-light fs-14">
                ...
                <Col xxl={cxxl || ''} lg={clg || ''} md={cmd || ''}>
                    <div className="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden">
                        ...
                        <div className="product-content p-4">
                            <p className="text-uppercase fw-semibold text-body mb-2">Summer Sales</p>
                            <h1 className="lh-base ff-secondary display-6 display-xl-5">Trendy Fashion Clothes</h1>
                            <div className="product-btn mt-3 mt-xl-4">
                                <Link to="/products-grid/right" className="link-effect link-primary fs-14">
                                    Shop Now <i className="bi bi-arrow-right ms-2"></i>
                                </Link>
                            </div>
                        </div>
