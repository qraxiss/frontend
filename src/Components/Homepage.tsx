    ...
    return (
        <React.Fragment>
            <div className="noUi-pips noUi-pips-horizontal">
                ...
                <div className="noUi-value noUi-value-horizontal noUi-value-large" data-value="0" style={{ left: '0%' }}>
                    0
                </div>
                ...
                <div className="noUi-value noUi-value-horizontal noUi-value-large" data-value="500" style={{ left: '25%' }}>
                    500
                </div>
                ...
                <div className="noUi-value noUi-value-horizontal noUi-value-large" data-value="1000" style={{ left: '50%' }}>
                    1000
                </div>
                ...
                <div className="noUi-value noUi-value-horizontal noUi-value-large" data-value="1500" style={{ left: '75%' }}>
                    1500
                </div>
                ...
                <div className="noUi-value noUi-value-horizontal noUi-value-large" data-value="2000" style={{ left: '100%' }}>
                    2000
                </div>
            </div>
        </React.Fragment>
