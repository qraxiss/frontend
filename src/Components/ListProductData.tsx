            ...
            <Row id="layout-noSidebar">
                <Col xl={12}>
                    <div id="product-list">
                        ...
                        (currentdata || [])?.map((item: any, key: any) => {
                            return (
                                <Card className="ribbon-box" key={key}>
                                            ...
                                            <Col className="col-md">
                                                <div>
                                                    ...
                                                    <p className="text-muted mb-3">
                                                        T-Shirt house best black boys T-Shirt fully cotton material all size available hirt fully
                                                        cotton material all size available.
                                                    </p>
                                                    <div className="d-flex gap-1">
                                                        ...
                                                        <span className="badge bg-danger-subtle text-danger align-middle ms-1">Out of stock</span>
                                                    </div>
                                                </div>
                                                <div className="mt-3">
