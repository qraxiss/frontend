    ...
    const columns: any = useMemo(
        () => [
            ...
            },
            {
                ...
                accessor: (row: any) => (
                    <>
                        <span className={`badge bg-${row.bg}-subtle text-${row.bg} align-middle ms-1`}>{row.stock}</span>
                    </>
                ),
                filterable: true
            },
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Menu as="ul">
                                <Dropdown.Item as="li" href="#/action-1">
                                    <i className="ri-eye-line me-2 align-bottom text-muted"></i>View
                                </Dropdown.Item>
                                <Dropdown.Item as="li" href="#/action-2">
                                    <i className="ri-shopping-cart-line me-2 align-bottom text-muted"></i>cart
                                </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </>
