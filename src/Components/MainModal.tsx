...
import { addItemToCart, deleteItemFromCart, cartQuery, login } from 'lib/common-queries'
                ...
                <Card.Header className="border-bottom-dashed p-4">
                  <div className="d-sm-flex">
                    ...
                    <div className="flex-shrink-0 mt-sm-0 mt-3">
                      <h6>
                        <span className="text-muted fw-normal">Legal Registration No:</span> <span id="legal-register-no">987654</span>
                      </h6>
                      <h6>
                      ...
                      <div className="alert alert-info">
                        <p className="mb-0">
                          ...
                          <span id="note">
                            ...
                            online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be
  ...
  return (
    <React.Fragment>
      <Offcanvas show={show} onHide={handleClose} backdrop="static" placement="end">
        ...
        <Offcanvas.Body className=" px-0">
          <SimpleBar className="h-100">
            <ul className="list-group list-group-flush cartlist"></ul>
            <Container>
