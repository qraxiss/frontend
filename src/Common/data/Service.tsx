...
const slider = [
  {
    id: 1,
    discription:
      '"Clean design. document is just a fews page but i should be like this cuz when looking on laravel project it well prepare. everytime i need a component or something else. easy to find."',
    img: avatar2,
    title: 'George Obrien',
    name: 'Velzon User',
    top: 0
